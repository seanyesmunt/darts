...
function Game(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item text-center border-gray-100 p-5", {
        "bg-teal-600": isMine
      }),
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.2beb66a0a8e3715df314.hot-update.js.map