...
function NewGame(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    autoComplete: "off",
    autoFocus: true,
    className: "block w-full shadow appearance-none border h-20 md:h-40 text-6xl rounded py-2 px-3 text-gray-700 placeholder-gray-400 leading-tight focus:outline-none focus:shadow-outline",
    id: "username",
    type: "text",
...
//# sourceMappingURL=new.js.7961c5d55a42f9eb78e5.hot-update.js.map