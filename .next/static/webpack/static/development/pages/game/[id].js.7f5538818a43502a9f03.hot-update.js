...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    ...
    className: "mt-24 text-sm md:w-auto text-2xl bg-teal-500 hover:bg-teal-700 text-white py-2 px-4 rounded-lg shadow",
    onClick: function onClick() {
...
//# sourceMappingURL=[id].js.7f5538818a43502a9f03.hot-update.js.map