...
function Header() {
  ...
  return __jsx("nav", {
    ...
    className: "font-semibold text-3xl hover:text-teal-200 tracking-tight",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
    ...
    className: "font-semibold text-3xl text-white bg-teal-700 p-2 rounded tracking-tight",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
...
//# sourceMappingURL=index.js.5144f775af219e4080fe.hot-update.js.map