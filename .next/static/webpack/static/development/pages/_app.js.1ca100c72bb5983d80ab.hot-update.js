...
function useGetGame(gameIDFromUrl) {
  ...
  react__WEBPACK_IMPORTED_MODULE_1___default.a.useEffect(function () {
    ...
    if (gameID && userID) {
      Object(_api_firebase__WEBPACK_IMPORTED_MODULE_4__["getGame"])(gameID, userID, onUpdate).then(function (gameFromDB) {
        debugger;
        setGame(gameFromDB);
...
//# sourceMappingURL=_app.js.1ca100c72bb5983d80ab.hot-update.js.map