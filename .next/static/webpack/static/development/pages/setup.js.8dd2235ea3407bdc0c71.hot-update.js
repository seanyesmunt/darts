...
/*!*************************!*\
  !*** ./api/firebase.ts ***!
  \*************************/
/*! exports provided: getUser, createGame, getGame, getGameId, addPlayerToGame, updateScore, resetScore, newGame */
...
function updateScore(gameID, userID, number) {// return new Promise((resolve, reject) => {
  //   db(`games/${gameID}`)
  //     .once("value")
  //     .then(snapshot => {
  //       const game = snapshot.val();
...
//# sourceMappingURL=setup.js.8dd2235ea3407bdc0c71.hot-update.js.map