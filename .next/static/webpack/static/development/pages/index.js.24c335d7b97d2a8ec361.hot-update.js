...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    autoFocus: true,
    autoComplete: "off",
    className: "block shadow appearance-none border h-40 text-6xl rounded py-2 px-3 bg-teal-100 text-gray-800 placeholder-gray-800 leading-tight focus:outline-none focus:shadow-outline",
    type: "text",
    placeholder: "4b90",
    value: gameIDToJoin,
...
//# sourceMappingURL=index.js.24c335d7b97d2a8ec361.hot-update.js.map