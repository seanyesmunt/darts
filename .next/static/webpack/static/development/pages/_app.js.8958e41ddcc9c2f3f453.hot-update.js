...
function useGetGame(gameIDFromUrl) {
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(function () {
    ...
    if (gameID && userID) {
      Object(_api_firebase__WEBPACK_IMPORTED_MODULE_5__["getGame"])(gameID, userID, onUpdate);
    }
  }, [gameID, userID]);
  return [game, error];
}
function useGetGameID(name) {
...
//# sourceMappingURL=_app.js.8958e41ddcc9c2f3f453.hot-update.js.map