...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    className: "mr-5 bg-white hover:bg-gray-200 text-blue-900 font-bold py-2 px-4 border-b-4 border-gray-100 hover:border-gray-200 rounded",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40,
    ...
    className: "bg-orange-400 hover:bg-orange-300 text-white font-bold py-2 px-4 border-b-4 border-orange-500 hover:border-orange-400 rounded",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46,
...
//# sourceMappingURL=index.js.4ac387f153a3333311a4.hot-update.js.map