...
function Game(props) {
  ...
  scoreEvents.forEach(function (scoreEvent) {
    ...
    if (usersScoreForHitValue < 3) {
      ...
      console.log("score[scoreEventUserID][hitValue]", score[scoreEventUserID][hitValue]);

      if (typeof score[scoreEventUserID][hitValue] === "string") {// debugger;
      }
...
//# sourceMappingURL=[id].js.76a06c71e1cc9faf6e35.hot-update.js.map