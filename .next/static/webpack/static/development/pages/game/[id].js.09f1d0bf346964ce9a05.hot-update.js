...
function Game(props) {
  ...
  var highestScore = Object.values(score).reduce(function (acc, player) {
    if (player.total_score > acc) {
      return score.total;
    } else {
      return acc;
    }
  }, 0); // const lowestScore = players.reduce((acc, player) => {
...
//# sourceMappingURL=[id].js.09f1d0bf346964ce9a05.hot-update.js.map