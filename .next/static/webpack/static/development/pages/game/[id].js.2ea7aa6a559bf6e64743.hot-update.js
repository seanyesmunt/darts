...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: value,
      className: "score__item border-gray-500 h-16 ".concat(index === 0 ? "h-24 border-t" : "", " md:h-24 px-4 flex items-center justify-center"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113,
...
//# sourceMappingURL=[id].js.2ea7aa6a559bf6e64743.hot-update.js.map