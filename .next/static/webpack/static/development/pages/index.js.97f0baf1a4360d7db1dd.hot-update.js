...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    className: "mr-4 w-full md:w-auto text-xl bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40,
    ...
    className: "text-xl mt-4 md:mt-0 bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
...
//# sourceMappingURL=index.js.97f0baf1a4360d7db1dd.hot-update.js.map