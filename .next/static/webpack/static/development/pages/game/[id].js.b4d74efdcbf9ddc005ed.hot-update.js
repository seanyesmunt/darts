...
function ScoreBoard(props) {
  ...
  var userID = Object(_effects_user__WEBPACK_IMPORTED_MODULE_2__["useGetUserID"])();
  return __jsx("div", {
    className: "text-sm md:text-2xl bg-teal-800 rounded-lg chalk",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 107,
    ...
    return __jsx("div", {
      key: value,
      className: "score__item border-t border-gray-500 h-16 ".concat(index === 0 ? "h-24 border-0" : "", " md:h-24 px-4 flex items-center justify-center"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item border-t border-gray-500 h-24 md:h-24 w-24 text-center pt-2 ", {
        "bg-teal-700": isMine
      }),
      __self: _this,
      __source: {
...
function ScoreRow(props) {
  ...
  return __jsx("div", {
    className: "score__item border-t border-gray-500 h-16 md:h-24 flex items-stretch relative",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 169,
...
//# sourceMappingURL=[id].js.b4d74efdcbf9ddc005ed.hot-update.js.map