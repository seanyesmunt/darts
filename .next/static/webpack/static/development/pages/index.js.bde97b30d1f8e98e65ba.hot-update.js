...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    className: "mr-4 bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-xl shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
    ...
    className: "bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-xl shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47,
...
//# sourceMappingURL=index.js.bde97b30d1f8e98e65ba.hot-update.js.map