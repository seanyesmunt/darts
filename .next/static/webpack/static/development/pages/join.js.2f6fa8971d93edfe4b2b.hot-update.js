...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    type: "submit",
    className: "mr-4 w-full md:w-auto text-4xl bg-blue-600 hover:bg-blue-800 text-white py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
    ...
    className: "mt-4 md:mt-0 w-full md:w-auto text-4xl bg-gray-700 hover:bg-gray-800 text-white py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
...
//# sourceMappingURL=join.js.2f6fa8971d93edfe4b2b.hot-update.js.map