...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  }, "Join Someones Game"))),  true && __jsx("div", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57,
    ...
    autoFocus: true,
    autoComplete: "off",
    className: "block shadow appearance-none border h-40 text-6xl rounded py-2 px-3 bg-teal-100 text-gray-800 placeholder-gray-400 leading-tight focus:outline-none focus:shadow-outline",
    type: "text",
    placeholder: "4b90",
    value: gameIDToJoin,
...
//# sourceMappingURL=index.js.a06c45d4bc9197a81292.hot-update.js.map