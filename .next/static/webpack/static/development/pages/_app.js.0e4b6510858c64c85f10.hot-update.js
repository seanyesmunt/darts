...
if (!firebase__WEBPACK_IMPORTED_MODULE_1__["apps"].length) {
  firebase__WEBPACK_IMPORTED_MODULE_1__["initializeApp"](config);
  firebase__WEBPACK_IMPORTED_MODULE_1__["database"]();
} // DB types


function getUser(userId) {
  return firebase__WEBPACK_IMPORTED_MODULE_1__["database"]().ref("/users/" + userId).once("value").then(function (snapshot) {
...
function createUser(userId) {
  ...
  return new Promise(function (resolve, reject) {
    firebase__WEBPACK_IMPORTED_MODULE_1__["database"]().ref("users/" + userId).set(user, function (error) {
      if (error) {
...
//# sourceMappingURL=_app.js.0e4b6510858c64c85f10.hot-update.js.map