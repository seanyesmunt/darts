...
function gameUndoLastMove(gameID, userID) {
  return new Promise(function (resolve, reject) {
    db("games/".concat(gameID)).once("value").then(function (snapshot) {
      var game = snapshot.val();
...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      onClick: _api_firebase__WEBPACK_IMPORTED_MODULE_7__["gameUndoLastMove"],
...
//# sourceMappingURL=[id].js.91b6e00d71fdf8858f11.hot-update.js.map