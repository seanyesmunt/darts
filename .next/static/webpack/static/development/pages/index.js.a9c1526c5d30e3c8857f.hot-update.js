...
/*!*************************!*\
  !*** ./api/firebase.ts ***!
  \*************************/
/*! exports provided: getUser, createGame, getGame, getGameId, addPlayerToGame, updateGameScore, resetScore, newGame */
...
function addPlayerToGame(gameID, userID, name) {// return new Promise((resolve, reject) => {
  //   db(`games/${gameID}`)
  //     .once("value")
  //     .then(snapshot => {
...
function updateGameScore(gameID, userID, number) {// return new Promise((resolve, reject) => {
  //   db(`games/${gameID}`)
  //     .once("value")
  //     .then(snapshot => {
  //       const game = snapshot.val();
...
//# sourceMappingURL=index.js.a9c1526c5d30e3c8857f.hot-update.js.map