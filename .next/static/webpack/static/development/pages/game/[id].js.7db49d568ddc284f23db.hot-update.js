...
function Game(props) {
  ...
  return __jsx("div", {
    ...
    onClick: function onClick() {
      return Object(_api_firebase__WEBPACK_IMPORTED_MODULE_4__["newGame"])(gameID);
    },
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_2___default()("score__item text-center border-gray-400 p-5", {
        "bg-teal-600": isMine
      }),
      __self: _this,
      __source: {
...
function ScoreRow(props) {
  ...
  return __jsx("div", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()("flex-1 text-white ont-bold w-100", {
...
//# sourceMappingURL=[id].js.7db49d568ddc284f23db.hot-update.js.map