...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    className: "flex flex-col md:flex-row mt-5 pb-24",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38,
    ...
    className: "mr-4 text-4xl bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40,
    ...
    className: "text-4xl bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
...
//# sourceMappingURL=index.js.260762a7077b54ac8f16.hot-update.js.map