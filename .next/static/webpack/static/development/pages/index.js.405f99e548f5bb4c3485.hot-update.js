...
function updateScore(gameID, userID, number, newScore) {
  return new Promise(function (resolve, reject) {
    db.ref("games/" + gameID).once("value").then(function (snapshot) {
      ...
      newGame.players = newGame.players.length > 2 ? handleThreePlayerGame(userID, newGame.players) : handleTwoPlayerGame(userID, newGame.players);
...
//# sourceMappingURL=index.js.405f99e548f5bb4c3485.hot-update.js.map