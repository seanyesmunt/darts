...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    ...
    className: "mt-24 md:w-auto text-2xl bg-teal-500 hover:bg-teal-700 text-white py-2 px-4 text-size-sm rounded-lg shadow",
    onClick: function onClick() {
...
//# sourceMappingURL=[id].js.30491ca0dd1748718335.hot-update.js.map