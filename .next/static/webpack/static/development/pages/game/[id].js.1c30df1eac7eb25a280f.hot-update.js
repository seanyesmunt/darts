...
function ScoreRow(props) {
  ...
  return __jsx("div", {
    ...
    className: "bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-2 px-4 rounded-l border-gray-300",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11,
    ...
    className: "bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-2 px-4 rounded-r border-gray-300",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=[id].js.1c30df1eac7eb25a280f.hot-update.js.map