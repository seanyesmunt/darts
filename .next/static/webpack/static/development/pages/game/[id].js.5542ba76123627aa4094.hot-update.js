...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    ...
    className: "mt-8 w-full md:w-auto text-2xl bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow",
    onClick: function onClick() {
...
function ScoreBoard(props) {
  ...
  var userID = Object(_effects_user__WEBPACK_IMPORTED_MODULE_2__["useGetUserID"])();
  return __jsx("div", {
    className: "bg-teal-800 rounded-lg",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 107,
    ...
    className: "mx-2 text-white border-b-8",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 108,
...
//# sourceMappingURL=[id].js.5542ba76123627aa4094.hot-update.js.map