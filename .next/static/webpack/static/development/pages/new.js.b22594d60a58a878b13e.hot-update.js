...
function NewGame(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    autoComplete: "off",
    autoFocus: true,
    className: "block w-full shadow appearance-none border h-40 text-6xl rounded py-2 px-3 text-gray-700 placeholder-gray-400 leading-tight focus:outline-none focus:shadow-outline",
    id: "username",
    type: "text",
    ...
    className: "mr-4 w-full md:w-auto text-4xl bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39,
...
//# sourceMappingURL=new.js.b22594d60a58a878b13e.hot-update.js.map