...
function handleTwoPlayerGame(userID, originalPlayers, number) {
  ...
  newPlayers = newPlayers.map(function (player) {
    ...
    if (scoreForNumber === 3) {
      // Update other scores
      newPlayer.score.total += number === "bull" ? 50 : number;
    } else {
...
function handleThreePlayerGame(userID, originalPlayers, number) {
  ...
  newPlayers = newPlayers.map(function (player) {
    ...
    var newPlayer = _objectSpread({}, player); // newPlayer.score[number] = newScore;
...
//# sourceMappingURL=index.js.a81cbcdf5008cf7feb83.hot-update.js.map