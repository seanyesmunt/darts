...
function getGame(gameID, userID, options, onUpdate) {
  return new Promise(function (resolve, reject) {
...
function useGetGame(gameID, options) {
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(function () {
    ...
    if (gameID && userID) {
      Object(_api_firebase__WEBPACK_IMPORTED_MODULE_3__["getGame"])(gameID, userID, options, onUpdate);
    }
  }, [gameID, userID]);
  return [game, error];
}
...
//# sourceMappingURL=_app.js.2aa717601d9e2e4a78f8.hot-update.js.map