...
function createUser(userId) {
  ...
  return new Promise(function (resolve, reject) {
    firebase__WEBPACK_IMPORTED_MODULE_0__["database"]().ref("users/" + userId).set(user, function (error) {
      if (error) {
...
//# sourceMappingURL=_app.js.87d628fdacb057276aa7.hot-update.js.map