...
function Game(props) {
  ...
  var userID = Object(_effects_user__WEBPACK_IMPORTED_MODULE_2__["useGetUserID"])();
  return __jsx("div", {
    className: "mt-10 py-10 px-5 bg-teal-700 chalk text-white rounded",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
    ...
    return __jsx("div", {
      className: "score__item pr-2 flex items-center justify-center",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 40,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item text-center border-gray-200 p-5", {
        "bg-teal-600": isMine
      }),
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.f0333f0340515882c593.hot-update.js.map