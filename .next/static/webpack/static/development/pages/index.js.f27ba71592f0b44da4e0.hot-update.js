...
function Home(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    className: "chalk flex flex-1 items-center justify-center bg-teal-600 text-white",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
    ...
    className: "mr-5 bg-teal-600 hover:bg-teal-500 text-white font-bold py-2 px-4 border-b-4 border-teal-800 hover:border-teal-600 rounded",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40,
...
//# sourceMappingURL=index.js.f27ba71592f0b44da4e0.hot-update.js.map