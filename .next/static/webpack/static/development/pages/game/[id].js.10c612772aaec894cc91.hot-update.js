...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    ...
    className: "mt-4md:mt-24 w-full md:w-auto text-2xl bg-teal-500 hover:bg-teal-700 text-white py-2 px-4 rounded-lg shadow",
    ...
    className: "mt-24 md:w-auto text-2xl bg-gray-800 hover:bg-teal-700 text-white py-2 px-4 text-xs rounded-lg shadow",
    onClick: function onClick() {
...
//# sourceMappingURL=[id].js.10c612772aaec894cc91.hot-update.js.map