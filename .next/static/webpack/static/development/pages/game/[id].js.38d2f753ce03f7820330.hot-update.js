...
function Game(props) {
  ...
  var userID = Object(_effects_user__WEBPACK_IMPORTED_MODULE_3__["useGetUserID"])(); // Initialize score object based on how many players there are
  ...
  var highestScore = Object.values(score).reduce(function (acc, score) {
    if (score.total > acc) {
      return score.total;
    } else {
      return acc;
  ...
  console.log("highest", highestScore); // const lowestScore = players.reduce((acc, player) => {
...
//# sourceMappingURL=[id].js.38d2f753ce03f7820330.hot-update.js.map