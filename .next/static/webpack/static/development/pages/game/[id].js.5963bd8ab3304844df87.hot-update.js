...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: value,
      className: "score__item h26 md:h-24 px-4 flex items-center justify-center",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item h26 md:h-24 w-24 border-gray-400 text-center pt-2 chalk", {
        "bg-teal-700": isMine
      }),
      __self: _this,
      __source: {
...
function ScoreRow(props) {
  ...
  return __jsx("div", {
    className: "score__item h26 md:h-24 flex items-stretch relative",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 167,
...
//# sourceMappingURL=[id].js.5963bd8ab3304844df87.hot-update.js.map