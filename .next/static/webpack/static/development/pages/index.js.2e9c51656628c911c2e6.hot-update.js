...
function Header() {
  ...
  return __jsx("nav", {
    className: "chalk flex items-center justify-between flex-wrap p-6 bg-teal-900 text-white",
    __self: this,
    __source: {
    ...
    className: "font-semibold text-4xl hover:text-indigo-400 tracking-tight",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14,
...
//# sourceMappingURL=index.js.2e9c51656628c911c2e6.hot-update.js.map