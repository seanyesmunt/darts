...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    ...
    className: "mt-24 md:w-auto text-2xl bg-gray-500 hover:bg-teal-700 text-white py-2 px-4 text-xs rounded-lg shadow",
    onClick: function onClick() {
...
//# sourceMappingURL=[id].js.633983a24b12b102ecb8.hot-update.js.map