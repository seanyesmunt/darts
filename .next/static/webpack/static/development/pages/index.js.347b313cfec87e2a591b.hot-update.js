...
function updateScore(gameID, userID, number, newScore) {
  return new Promise(function (resolve, reject) {
    db.ref("games/" + gameID).once("value").then(function (snapshot) {
      ...
      newGame.players = newGame.players.length > 2 ? handleThreePlayerGame(userID, newGame.players, number) : handleTwoPlayerGame(userID, newGame.players);
...
//# sourceMappingURL=index.js.347b313cfec87e2a591b.hot-update.js.map