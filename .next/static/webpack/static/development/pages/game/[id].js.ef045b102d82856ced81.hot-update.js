...
function Game(props) {
  ...
  return hasWinner ? __jsx("div", {
    className: "px-2 md:px-4 mx-auto",
    __self: this,
    __source: {
...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: value,
      className: "score__item h-16 md:h-24 px-4 flex items-center justify-center",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item h-16 md:h-24 w-24 border-gray-400 text-center pt-2 chalk", {
        "bg-teal-700": isMine
      }),
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.ef045b102d82856ced81.hot-update.js.map