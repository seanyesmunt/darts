...
function NewGame(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    autoComplete: "off",
    autoFocus: true,
    className: "block w-full shadow appearance-none border h-24 md:h-40 text-6xl rounded py-2 px-3 text-gray-700 placeholder-gray-400 leading-tight focus:outline-none focus:shadow-outline",
    id: "username",
    type: "text",
...
//# sourceMappingURL=new.js.f98d7a6681d26a3666fb.hot-update.js.map