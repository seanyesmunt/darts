...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: value,
      className: "h-20 px-2 flex items-center justify-center",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 105,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("h-20 text-center border-gray-400 p-5", {
        "bg-teal-600": isMine
      }),
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.08baa9b226128d95d6e2.hot-update.js.map