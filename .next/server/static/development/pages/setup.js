...
function Setup() {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(() => {
    if (userID && name) {
      Object(_api_firebase__WEBPACK_IMPORTED_MODULE_3__["createGame"])(userID, name).then(game => {
        push(`/game/${game.id}`);
      });
    }
  }, [userID, name]);
...
/***/ 6:
/*!*******************************!*\
  !*** multi ./pages/setup.tsx ***!
  \*******************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/sean/Workspace/darts/pages/setup.tsx */"./pages/setup.tsx");
