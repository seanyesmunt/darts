...
function getGame(gameID, userID, onUpdate) {
  return new Promise(function (resolve, reject) {
    firebase_app__WEBPACK_IMPORTED_MODULE_1__["database"]().ref("/games/" + gameID).on("value", function (snapshot) {
      ...
      if (game) {
        ...
        resolve(createGame(gameID, userID));
      }
    });
  });
}
...
//# sourceMappingURL=index.js.34c445764b7a50c251c9.hot-update.js.map