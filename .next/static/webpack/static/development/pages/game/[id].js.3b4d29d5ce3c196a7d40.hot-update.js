...
function Game(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item text-center border-gray-500 p-5", {
        "bg-teal-600": isMine
      }),
      __self: _this,
      __source: {
...
//# sourceMappingURL=[id].js.3b4d29d5ce3c196a7d40.hot-update.js.map