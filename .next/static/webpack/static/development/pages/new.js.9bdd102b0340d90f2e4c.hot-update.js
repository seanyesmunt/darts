...
function NewGame(props) {
  ...
  return __jsx(_component_page__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    type: "submit",
    className: "mr-4 w-full md:w-auto text-2xl bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
    ...
    className: "mt-4 md:mt-0 w-full md:w-auto text-2xl bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-lg shadow",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41,
...
//# sourceMappingURL=new.js.9bdd102b0340d90f2e4c.hot-update.js.map