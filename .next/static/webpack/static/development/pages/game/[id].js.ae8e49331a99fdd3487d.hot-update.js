...
function ScoreBoard(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      key: value,
      className: "score__item border-b border-gray-500 h-16 ".concat(index === 0 ? "h-24" : "", " md:h-24 px-4 flex items-center justify-center"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113,
    ...
    return __jsx("div", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("score__item border-b border-gray-500 h-24 md:h-24 w-24 text-center pt-2 ", {
        "bg-teal-700": isMine
      }),
      __self: _this,
      __source: {
...
function ScoreRow(props) {
  ...
  return __jsx("div", {
    className: "score__item border-b border-gray-500 h-16 md:h-24 flex items-stretch relative",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 169,
...
//# sourceMappingURL=[id].js.ae8e49331a99fdd3487d.hot-update.js.map